...
def generate_mapped_movieid(movies_list,movies_df):
...
def createnewgraph(mappedmovieid,ratings_list):
    edge_index = data['user', 'rates', 'movie'].edge_index[0,:]
